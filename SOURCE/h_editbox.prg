...
FUNCTION _DefineEditbox ( ControlName, ParentFormName, x, y, w, h, value, ;
      ...
      strikeout, field, backcolor, fontcolor, novscroll, nohscroll, noborder, nId, bInit )
*-----------------------------------------------------------------------------*
   ...
   IF _HMG_BeginDialogActive
      ...
      Style := ES_MULTILINE + ES_WANTRETURN + WS_CHILD + iif( noborder, 0, WS_BORDER )
   ...
   ELSE
      ...
      IF x == NIL .OR. y == NIL
         ...
         IF i > 0
            ...
            ControlHandle := InitEditBox ( ParentFormHandle , 0, x, y, w, h, '', noborder , maxlength , readonly, invisible, notabstop , novscroll , nohscroll )
