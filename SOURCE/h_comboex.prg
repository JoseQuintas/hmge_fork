...
FUNCTION _DefineComboEx ( ControlName, ParentForm, x, y, w, rows, value, ;
      ...
      backcolor, fontcolor, ImageList, nItemHeight, bInit, notrans, imagewidth, imageheight )
*-----------------------------------------------------------------------------*
   ...
   IF x == NIL .OR. y == NIL
      ...
      IF i > 0
         ...
         aRet := InitComboBoxEx ( _HMG_aFormReBarHandle [i], 0, x, y, w, '', notrans , h, invisible, notabstop, .F. , displaychange, _HMG_IsXPorLater, aImages, ImageList, imagewidth, imageheight )
   ...
   ELSE
      ...
      aRet := InitComboBoxEx ( ParentForm, 0, x, y, w, '', notrans , h, invisible, notabstop, .F. , displaychange, _HMG_IsXPorLater, aImages, ImageList, imagewidth, imageheight )
   ...
   _HMG_aControlBrushHandle  [k] :=  aRet [2]  // handle to ImageList
   _HMG_aControlEnabled  [k] :=  .T.
   _HMG_aControlMiscData1 [k] := { 1, ;  // value used for recognition between extend and standard COMBO
      displaychange, nItemHeight }
