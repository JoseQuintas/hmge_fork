...
#translate SET LANGUAGE TO BYELORUSSIAN	=>  _HMG_LANG_ID := '  ' ; REQUEST HB_LANG_BEWIN	; HB_LANGSELECT( "BE" )		; InitMessages()
...
#translate SET LANGUAGE TO BYELORUSSIAN	=>  _HMG_LANG_ID := '  ' ; REQUEST HB_LANG_BEWIN	; HB_LANGSELECT( "BEWIN" )	; InitMessages()
