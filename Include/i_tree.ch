...
#translate GetProperty ( <FormName> , <ControlName> , "AllValue" ) ;
   => ;
   TreeItemGetAllValues ( <ControlName> , <FormName> )

#translate GetProperty ( <FormName> , <ControlName> , "ParentValue" , <item> ) ;
   => ;
   TreeItemGetParentValue ( <ControlName> , <FormName> , <item> )

#translate GetProperty ( <FormName> , <ControlName> , "ChildValue" , <item> ) ;
   => ;
   TreeItemGetChildValues ( <ControlName> , <FormName> , <item> )

#translate GetProperty ( <FormName> , <ControlName> , "SiblingValue" , <item> ) ;
   => ;
   TreeItemGetSiblingValues ( <ControlName> , <FormName> , <item> )
