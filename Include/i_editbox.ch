...
#command @ <row>,<col> EDITBOX <name> ;
	...
	_DefineEditBox ( <(name)>, <(parent)>, <col>, <row>, <w>, <h>, <value>, <f>, <s>, <tooltip>, <maxlength>, ;
		...
		<.novscroll.>, <.nohscroll.>, <.noborder.>, <nId>, <bInit> )
...
#command REDEFINE EDITBOX <name> ;
    ...
    [ ON INIT <bInit> ] ;
    =>;
	_DefineEditBox ( <(name)>, <(parent)>, 0, 0, 0, 0, <value> ,<f>,<s> , <tooltip>  , <maxlength>  , <{gotfocus}>  , <{change}>  , <{lostfocus}>  , <.readonly.> , .f. , <helpid>, <.invisible.>, <.notabstop.> ,<.bold.>, <.italic.>, <.underline.>, <.strikeout.> , <(field)> , <backcolor> , <fontcolor> , <.novscroll.> , <.nohscroll.> , <.noborder.> , <nId>, <bInit> )
...
#command EDITBOX <name> ;
	...
	_DefineEditBox ( <(name)>, <(parent)>, , , <w>, <h>, <value>, <f>, <s>, <tooltip>, <maxlength>, ;
		...
		<.bold.>, <.italic.>, <.underline.>, <.strikeout.>, <(field)>, <backcolor>, <fontcolor>, <.novscroll.>, <.nohscroll.>, <.noborder.>, 0, <bInit> )
