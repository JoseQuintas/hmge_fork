...
#xtranslate This . <p:Title,Parent,NotifyIcon,NotifyTooltip,Cursor,FocusedControl,MinHeight,MinWidth,MaxHeight,MaxWidth,TitleBar,SysMenu,Sizable,Closable,MaxButton,MinButton,Visible,Enabled,Topmost,HelpButton,Object> => GetProperty ( _HMG_THISFORMNAME , <"p"> )
...
#xtranslate ThisWindow . <p:Title,Parent,NotifyIcon,NotifyTooltip,Cursor,FocusedControl,BackColor,Name,Handle,Type,Index,Row,Col,Width,Height,MinHeight,MinWidth,MaxHeight,MaxWidth,TitleBar,SysMenu,Sizable,Closable,MaxButton,MinButton,Visible,Enabled,Topmost,HelpButton,Cargo,Object> => GetProperty ( _HMG_THISFORMNAME , <"p"> )
...
#xtranslate ThisWindow . <p:Activate,Center,EnableUpdate,DisableUpdate,Redraw,Release,Maximize,Minimize,Restore,Show,Hide,SetFocus> [ () ] => DoMethod ( _HMG_THISFORMNAME , <"p"> )
...
#xtranslate ThisRichEditBox . <p: GetClickLinkRange,GetClickLinkText> => GetProperty ( _HMG_THISFORMNAME , _HMG_THISCONTROLNAME , <"p"> )
...
#xtranslate This . <p:Redraw,Refresh,DeleteAllItems,Release,Play,Stop,Close,PlayReverse,Pause,Eject,OpenDialog,Resume,Save,GetArray,EnableUpdate,DisableUpdate,Action,OnClick,OnGotFocus,OnLostFocus,OnChange,OnDblClick,OnEnter,ColumnAutoFit,ColumnAutoFitH> [ () ] => DoMethod ( _HMG_THISFORMNAME , _HMG_THISCONTROLNAME , <"p"> )
...
#xtranslate This . IsInplaceEditEventFinish  => ( _HMG_GridInplaceEdit_StageEvent == 3 )
