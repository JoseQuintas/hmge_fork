...
*/
#define CLR_SKYPE	RGB(   0, 176, 240 )
#define CLR_VIBER	RGB( 125,  82, 158 )
#define CLR_VK		RGB(  93, 114, 148 )
#define CLR_TWIT	RGB( 118, 170, 235 )
#define CLR_FB		RGB(  71,  89, 149 )
#define CLR_OK		RGB( 238, 130,   8 )
