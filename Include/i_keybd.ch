...
=> ;
_HMG_InteractiveClose := 2

#xcommand SET INTERACTIVECLOSE QUERY MAIN ;
=> ;
_HMG_InteractiveClose := 3
...
=> ;
<baction> := _GetHotKeyBlock ( <(parent)> , 0 , VK_HOME   )
...
=> ;
<baction> := _GetHotKeyBlock ( <(parent)> , 0 , VK_RIGHT   )
...
=> ;
<baction> := _GetHotKeyBlock ( <(parent)> , MOD_ALT , VK_HOME   )
...
=> ;
<baction> := _GetHotKeyBlock ( <(parent)> , MOD_ALT , VK_RIGHT   )
...
=> ;
<baction> := _GetHotKeyBlock ( <(parent)> , MOD_SHIFT , VK_HOME   )
...
=> ;
<baction> := _GetHotKeyBlock ( <(parent)> , MOD_SHIFT , VK_RIGHT   )
...
=> ;
<baction> := _GetHotKeyBlock ( <(parent)> , MOD_CONTROL , VK_HOME   )
...
=> ;
<baction> := _GetHotKeyBlock ( <(parent)> , MOD_CONTROL , VK_RIGHT   )
