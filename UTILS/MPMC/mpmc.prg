...
PROCEDURE Main ( ProjectFile , Param1 , Param2 )
   ...
   LOCAL C , i , Line , WinFolder := GetTempDir(), EnvironmentFile
   ...
   IF File ( WinFolder + 'MPM.TMP' )

      RESTORE FROM ( WinFolder + 'MPM.TMP' ) ADDITIVE
   ...
   SAVE TO ( WinFolder + 'MPM.TMP' ) ALL LIKE DBS
...
PROCEDURE Build
   ...
   Out := Out + ' echo $(HRB_LIB_DIR)\hbwin.lib + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
   Out := Out + ' echo $(HRB_LIB_DIR)\xhb.lib + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
#endif
   Out := Out + ' echo $(HRB_LIB_DIR)\hbprinter.lib + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
   Out := Out + ' echo $(HRB_LIB_DIR)\miniprint.lib + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
   Out := Out + ' echo $(HRB_LIB_DIR)\bostaurus.lib + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
   Out := Out + ' echo $(HRB_LIB_DIR)\socket.lib + >> b32.bc' + Chr( 13 ) + Chr ( 10 )

   IF ZIPSUPPORT == .T.     
      Out := Out + ' echo $(HRB_LIB_DIR)\hbziparc.lib + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
      Out := Out + ' echo $(HRB_LIB_DIR)\hbmzip.lib   + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
      Out := Out + ' echo $(HRB_LIB_DIR)\minizip.lib  + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
      Out := Out + ' echo $(HRB_LIB_DIR)\hbzlib.lib   + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
   ENDIF
   ...
   IF MYSQLSUPPORT == .T.     
      Out := Out + ' echo $(HRB_LIB_DIR)\hbmysql.lib  + >> b32.bc' + Chr( 13 ) + Chr ( 10 )
...
PROCEDURE SaveEnvironment ( WinFolder )
   ...
   c += 'BCCFOLDER=C:\BORLAND\BCC58' + Chr( 13 ) + Chr( 10 )
