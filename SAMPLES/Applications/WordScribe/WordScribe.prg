...
DEFINE WINDOW wMain ;
  ...
  DEFINE SPLITBOX
    ...
    DEFINE TOOLBAR tlFile BUTTONSIZE 16, 16 FLAT
    ...
    DEFINE TOOLBAR tlEdit BUTTONSIZE 16, 16 FONT 'Arial' SIZE 8  FLAT
    ...
    DEFINE TOOLBAR tlText BUTTONSIZE 16, 16 SIZE 8  FLAT 
...
LOCAL cKey := Right( wMain.ebDoc.VALUE, 1 )
