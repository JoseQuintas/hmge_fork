...
FUNCTION Main(cRDD, cDSN)
   ...
   INDEX ON CODE_ID TO TEST_TABLE1_IND01         // No functions allowed in indexes, just fields
   ...
   dbSelectArea(cTableName1)
   SET INDEX TO TEST_TABLE1_IND01
   SET INDEX TO TEST_TABLE1_IND02 ADDITIVE
   SET ORDER TO 1

   SELECT 2
   SET INDEX TO TEST_TABLE2_IND01
