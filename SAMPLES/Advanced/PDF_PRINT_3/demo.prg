...
FUNCTION Main()
   ...
   @ 47.5, 10 HPDFPRINT SCALE "This is a sample Scaled Text." FONT "Arial" SIZE 22 BOLD COLOR { 255, 0, 0 } XSCALE 0.5 YSCALE 2
   ...
   @ 237, 151.5 HPDFPRINT Chr(72) FONT "ZapfDingbats" SIZE 64 BOLD COLOR {250,250,250}
