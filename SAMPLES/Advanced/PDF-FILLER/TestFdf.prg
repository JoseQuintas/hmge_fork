...
*------------------------------------------------------------------------------*
   ...
   //Open registry oReg key HKEY_CLASSES_ROOT Section 'Acrobat.FDFDoc\shell\Printto\command'
   // the following line does not show errors
   oReg:=TReg32():Create(HKEY_CLASSES_ROOT,"Acrobat.FDFDoc\shell\Printto\command", .F. )
