...
FUNCTION Main()
   ...
   DEFINE WINDOW &cForm AT nY, nX WIDTH nW HEIGHT nH TITLE cTitle ;
      ...
      @ nY, nX LABEL Label_Tsb VALUE "" WIDTH nW-nG*2 HEIGHT nH-nG*2 BACKCOLOR aTsbBClr BORDER 
      ...
      o:Event({ 9,"_Help"  }, {|ow,ky,cn,o| o := This.&(cn).Cargo, MsgDebug(ow:Name,ky,cn,"|" ,;
                                            This.&(cn).caption,This.&(cn).Picture,o,o:nBtn, o:cImage)  } )
      o:Event({10,"_Find"  }, {|ow,ky,cn,o| o := This.&(cn).Cargo, MsgDebug(ow:Name,ky,cn,"|" ,;
                                            This.&(cn).caption,This.&(cn).Picture,o,o:nBtn, o:cImage)  } )
      o:Event({11,"_RecIns"}, {|ow,ky,cn,o| o := This.&(cn).Cargo, MsgDebug(ow:Name,ky,cn,"|" ,;
                                            This.&(cn).caption,This.&(cn).Picture,o,o:nBtn, o:cImage)  } )
      o:Event({12,"_RecDel"}, {|ow,ky,cn,o| o := This.&(cn).Cargo, MsgDebug(ow:Name,ky,cn,"|" ,;
                                            This.&(cn).caption,This.&(cn).Picture,o,o:nBtn, o:cImage)  } )
      o:Event({70,"_Print" }, {|ow,ky,cn,o| o := This.&(cn).Cargo, MsgDebug(ow:Name,ky,cn,"|" ,;
                                            This.&(cn).caption,This.&(cn).Picture,o,o:nBtn, o:cImage)  } )
...
STATIC FUNCTION myToolBar(oWC)
   ...
   NEXT
   nWTxt := IIF(nWTxt < nHImg, nHImg, nWTxt )   // 48-высота bmp
   nW    := nWTxt + 5                           // ширина кнопки
   nH    := nHImg + 5 + nFSize + 5              // высота кнопки  
   ? "ToolBar: nW=",nW, "nH=",nH

   IF lBold 
      DEFINE TOOLBAREX ToolBar_1 CAPTION "Menu: - not displayed" BUTTONSIZE nW, nH FLAT ;
   ...
   owc:nHTBar := nH   // для корректировки высоты ToolBar
