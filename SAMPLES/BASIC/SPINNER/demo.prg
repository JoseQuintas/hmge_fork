...
*/
      ...
      @ 250,10 BUTTON Button_7 ;
         CAPTION "Show styles" ;
         ACTION MsgInfo( "Spinner_2 Increment: " + hb_NToS( Form_Main.Spinner_2.Increment ) + CRLF + ;
                         "Spinner_2 ReadOnly: " + cValToChar( Form_Main.Spinner_2.ReadOnly ) + CRLF + ;
